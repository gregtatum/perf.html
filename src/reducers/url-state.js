...
// Create a single empty list to help memoization work on empty lists with a simple
// strict equality check. Flow gets confused if we re-use the arrays between types.
