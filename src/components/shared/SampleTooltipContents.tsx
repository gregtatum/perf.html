...
import { IndexIntoSamplesTable, CategoryList, Thread } from "../../types/profile";
...
export default class SampleTooltipContents extends React.PureComponent<Props> {
  ...
  render() {
    ...
    return <>
        ...
        <Backtrace maxHeight="9.2em" stackIndex={stackIndex} thread={fullThread} implementationFilter="combined" />
      </>;
  }
}