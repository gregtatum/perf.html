...
class Settings extends PureComponent<Props> {
  ...
  render() {
    ...
    return <div className="networkSettings">
        <div className="networkSettingsSpacer" />
        <PanelSearch className="networkSettingsSearchField" label="Filter Networks: " title="Only display network requests that match a certain name" currentSearchString={searchString} onSearch={this._onSearch} />
      </div>;
  }
}
