...
type DetailProps = {
  ...
  readonly children?: void | null | boolean | string | number | React.ReactElement<any>;
};
...
type TooltipDetailComponent = React.ReactElement<typeof TooltipDetail>;
type Props = {
  // This component accepts only TooltipDetail children.
  readonly children: React.ChildrenArray<TooltipDetailComponent | null>;
};
