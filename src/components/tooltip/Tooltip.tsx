...
export default class Tooltip extends React.PureComponent<Props, State> {
  ...
  render() {
    ...
    if (interiorElement) {
      ...
      if (mouseY + MOUSE_OFFSET + interiorElement.offsetHeight >= window.innerHeight) {
      ...
      if (mouseX + MOUSE_OFFSET + interiorElement.offsetWidth >= window.innerWidth) {
    ...
    return ReactDOM.createPortal(<div className="tooltip" data-testid="tooltip" style={style} ref={this._takeInteriorElementRef}>
        {children}
