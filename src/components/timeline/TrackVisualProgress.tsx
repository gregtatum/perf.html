...
import { TRACK_VISUAL_PROGRESS_LINE_WIDTH, TRACK_VISUAL_PROGRESS_HEIGHT } from "../../app-logic/constants";
...
export class TrackVisualProgressImpl extends React.PureComponent<Props, State> {
  ...
  render() {
    ...
    return <div className="timelineTrackVisualProgress" style={{
      height: TRACK_VISUAL_PROGRESS_HEIGHT,
      '--graph-height': `${TRACK_VISUAL_PROGRESS_HEIGHT}px`
    }}>
        <TrackVisualProgressGraph progressGraphData={progressGraphData} lineWidth={TRACK_VISUAL_PROGRESS_LINE_WIDTH} graphHeight={TRACK_VISUAL_PROGRESS_HEIGHT} graphDotTooltipText={graphDotTooltipText} />
      </div>;
  }
}

export const TrackVisualProgress = explicitConnect<OwnProps, StateProps, DispatchProps>({
