  ...
  renderCurrentRoute() {
    ...
    switch (dataSource) {
      ...
      case 'compare':
        ...
        break;
      case 'from-addon':case 'from-file':case 'local':case 'public':case 'from-url':
        break;
      default:
    ...
    switch (phase) {
      case 'INITIALIZING':case 'PROFILE_LOADED':case 'DATA_RELOAD':
      ...
      case 'FATAL_ERROR':
        {
          ...
          return <ProfileRootMessage message={message} additionalMessage={additionalMessage} showLoader={false} />;
        }
      case 'DATA_LOADED':
