...
export function getMarkerSelectorsPerThread(threadSelectors: *) {
  ...
  // `typeof` trick.
  return {
    getMarkerGetter: (getMarkerGetter: typeof getMarkerGetter),
    getJankMarkerIndexesForHeader: (getJankMarkerIndexesForHeader: typeof getJankMarkerIndexesForHeader),
    getProcessedRawMarkerTable: (getProcessedRawMarkerTable: typeof getProcessedRawMarkerTable),
    getFullMarkerListIndexes: (getFullMarkerListIndexes: typeof getFullMarkerListIndexes),
    getNetworkMarkerIndexes: (getNetworkMarkerIndexes: typeof getNetworkMarkerIndexes),
    getSearchFilteredNetworkMarkerIndexes: (getSearchFilteredNetworkMarkerIndexes: typeof getSearchFilteredNetworkMarkerIndexes),
    getAreMarkerPanelsEmptyInFullRange: (getAreMarkerPanelsEmptyInFullRange: typeof getAreMarkerPanelsEmptyInFullRange),
    getMarkerChartMarkerIndexes: (getMarkerChartMarkerIndexes: typeof getMarkerChartMarkerIndexes),
    getSearchFilteredMarkerChartMarkerIndexes: (getSearchFilteredMarkerChartMarkerIndexes: typeof getSearchFilteredMarkerChartMarkerIndexes),
    getMarkerChartTimingAndBuckets: (getMarkerChartTimingAndBuckets: typeof getMarkerChartTimingAndBuckets),
    getCommittedRangeFilteredMarkerIndexes: (getCommittedRangeFilteredMarkerIndexes: typeof getCommittedRangeFilteredMarkerIndexes),
    getCommittedRangeAndTabFilteredMarkerIndexes: (getCommittedRangeAndTabFilteredMarkerIndexes: typeof getCommittedRangeAndTabFilteredMarkerIndexes),
    getCommittedRangeAndTabFilteredMarkerIndexesForHeader: (getCommittedRangeAndTabFilteredMarkerIndexesForHeader: typeof getCommittedRangeAndTabFilteredMarkerIndexesForHeader),
    getActiveTabFilteredMarkerIndexesWithoutGlobals: (getActiveTabFilteredMarkerIndexesWithoutGlobals: typeof getActiveTabFilteredMarkerIndexesWithoutGlobals),
    getTimelineVerticalMarkerIndexes: (getTimelineVerticalMarkerIndexes: typeof getTimelineVerticalMarkerIndexes),
    getFileIoMarkerIndexes: (getFileIoMarkerIndexes: typeof getFileIoMarkerIndexes),
    getMemoryMarkerIndexes: (getMemoryMarkerIndexes: typeof getMemoryMarkerIndexes),
    getIPCMarkerIndexes: (getIPCMarkerIndexes: typeof getIPCMarkerIndexes),
    getNetworkTrackTiming: (getNetworkTrackTiming: typeof getNetworkTrackTiming),
    getRangeFilteredScreenshotsById: (getRangeFilteredScreenshotsById: typeof getRangeFilteredScreenshotsById),
    getSearchFilteredMarkerIndexes: (getSearchFilteredMarkerIndexes: typeof getSearchFilteredMarkerIndexes),
    getPreviewFilteredMarkerIndexes: (getPreviewFilteredMarkerIndexes: typeof getPreviewFilteredMarkerIndexes),
    getSelectedMarkerIndex: (getSelectedMarkerIndex: typeof getSelectedMarkerIndex),
    getSelectedMarker: (getSelectedMarker: typeof getSelectedMarker),
    getRightClickedMarkerIndex: (getRightClickedMarkerIndex: typeof getRightClickedMarkerIndex),
    getRightClickedMarker: (getRightClickedMarker: typeof getRightClickedMarker),
    getIsNetworkChartEmptyInFullRange: (getIsNetworkChartEmptyInFullRange: typeof getIsNetworkChartEmptyInFullRange),
    getUserTimingMarkerIndexes: (getUserTimingMarkerIndexes: typeof getUserTimingMarkerIndexes),
    getUserTimingMarkerTiming: (getUserTimingMarkerTiming: typeof getUserTimingMarkerTiming),
  };
}
