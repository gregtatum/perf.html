...
export function getThreadSelectorsPerThread(threadIndex: ThreadIndex): * {
  ...
  // `typeof` trick.
  return {
    getThread: (getThread: typeof getThread),
    getStringTable: (getStringTable: typeof getStringTable),
    getSamplesTable: (getSamplesTable: typeof getSamplesTable),
    getNativeAllocations: (getNativeAllocations: typeof getNativeAllocations),
    getThreadRange: (getThreadRange: typeof getThreadRange),
    getFilteredThread: (getFilteredThread: typeof getFilteredThread),
    getRangeFilteredThread: (getRangeFilteredThread: typeof getRangeFilteredThread),
    getRangeAndTransformFilteredThread: (getRangeAndTransformFilteredThread: typeof getRangeAndTransformFilteredThread),
    getPreviewFilteredThread: (getPreviewFilteredThread: typeof getPreviewFilteredThread),
    getSampleIndexOffsetFromCommittedRange: (getSampleIndexOffsetFromCommittedRange: typeof getSampleIndexOffsetFromCommittedRange),
    getSampleIndexOffsetFromPreviewRange: (getSampleIndexOffsetFromPreviewRange: typeof getSampleIndexOffsetFromPreviewRange),
    getFriendlyThreadName: (getFriendlyThreadName: typeof getFriendlyThreadName),
    getThreadProcessDetails: (getThreadProcessDetails: typeof getThreadProcessDetails),
    getTransformLabels: (getTransformLabels: typeof getTransformLabels),
    getTransformStack: (getTransformStack: typeof getTransformStack),
    getViewOptions: (getViewOptions: typeof getViewOptions),
    getJsTracerTable: (getJsTracerTable: typeof getJsTracerTable),
    getExpensiveJsTracerTiming: (getExpensiveJsTracerTiming: typeof getExpensiveJsTracerTiming),
    getExpensiveJsTracerLeafTiming: (getExpensiveJsTracerLeafTiming: typeof getExpensiveJsTracerLeafTiming),
    getHasJsAllocations: (getHasJsAllocations: typeof getHasJsAllocations),
    getHasNativeAllocations: (getHasNativeAllocations: typeof getHasNativeAllocations),
    getCanShowRetainedMemory: (getCanShowRetainedMemory: typeof getCanShowRetainedMemory),
    getTabFilteredThread: (getTabFilteredThread: typeof getTabFilteredThread),
    getActiveTabFilteredThread: (getActiveTabFilteredThread: typeof getActiveTabFilteredThread),
  };
}
