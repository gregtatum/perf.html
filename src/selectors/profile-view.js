...
import { getMarkerSelectorsForThread } from './markers';
 ...
 */
export const getGlobalTrackFromReference: NonMemoizedSelector1<
  GlobalTrack,
  GlobalTrackReference
 ...
 */
export const getGlobalTrackAndIndexByPid: NonMemoizedSelector1<
 ...
 */
export const getLocalTracks: NonMemoizedSelector1<LocalTrack[], Pid> = (
  state,
  pid
) =>
  ensureExists(
 ...
 */
export const getLocalTrackFromReference: NonMemoizedSelector1<
  LocalTrack,
  LocalTrackReference
> = (state, trackReference) =>
...
export const getGlobalTrackName: NonMemoizedSelector1<string, TrackIndex> = (
  state,
  trackIndex
) => getGlobalTrackNames(state)[trackIndex];
...
export const selectorsForThread = (
  ...
  if (!(threadIndex in selectorsForThreads)) {
    ...
    selectorsForThreads[threadIndex] = {
      ...threadSelectors,
      ...getMarkerSelectorsForThread(threadSelectors),
    };
  }
