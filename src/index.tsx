...
import { addDataToWindowObject, logFriendlyPreamble } from "./utils/window-console";
...
render(<Root store={store} />, ensureExists(document.getElementById('root'), 'Unable to find the DOM element to attach the React element to.'));
