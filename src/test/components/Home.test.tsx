...
const FIREFOX = 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10.12; rv:55.0) Gecko/20100101 Firefox/55.0';
const SAFARI = 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_12_6) AppleWebKit/603.3.8 (KHTML, like Gecko) Version/10.1.2 Safari/603.3.8';
let userAgent;
...
describe('app/Home', function () {
  function setup(userAgentToConfigure: string): any {
    userAgent = userAgentToConfigure;
    const renderResults = render(<Provider store={createStore()}>
  ...
  it('renders a button to enable the popup when it is available', async () => {
    ...
    const instructions = await getInstructions('home-enable-popup-instructions');
