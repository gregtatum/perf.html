...
import { TRACK_NETWORK_ROW_HEIGHT, TRACK_NETWORK_ROW_REPEAT } from "../../app-logic/constants";
...
describe('VerticalIndicators', function () {
  ...
  it('displays tooltips', function () {
    ...
    fireEvent(firstIndicator, getMouseEvent('mousemove', {
      pageX: 11,
      pageY: 22
    }));
...
function setup() {
  ...
  const getIndicatorLines = () => renderResult.getAllByTestId('vertical-indicator-line');
