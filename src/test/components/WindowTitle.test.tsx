...
describe('WindowTitle', () => {
  it('shows basic window title', () => {
    ...
    expect(document.title).toBe('Firefox - 1/1/1970, 12:00:00 AM UTC - Firefox profiler');
  });
  ...
  it('shows platform details in the window title if it is available', () => {
    ...
    expect(document.title).toBe('Firefox - Intel Mac OS X 10.14 - 1/1/1970, 12:00:00 AM UTC - Firefox profiler');
  });
  ...
  it('shows profile name in the window title if it is available', () => {
    ...
    expect(document.title).toBe('good profile - Firefox - Intel Mac OS X 10.14 - 1/1/1970, 12:00:00 AM UTC - Firefox profiler');

    store.dispatch(changeProfileName('awesome profile'));
    expect(document.title).toBe('awesome profile - Firefox - Intel Mac OS X 10.14 - 1/1/1970, 12:00:00 AM UTC - Firefox profiler');
  });
});