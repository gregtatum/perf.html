...
import { retrieveProfileFromStore, retrieveProfileFromAddon, retrieveProfilesToCompare } from "../../actions/receive-profile";
...
describe('app/AppViewRouter', function () {
  ...
  it('renders temporary errors', function () {
    ...
    navigateToStoreLoadingPage();
    dispatch(temporaryError(new TemporaryError('This is a temporary error, wait a bit more.', {
      count: 3,
      total: 10
    })));
    expect(container.firstChild).toMatchSnapshot();
