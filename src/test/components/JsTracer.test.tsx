...
import { getBoundingBox, addRootOverlayElement, removeRootOverlayElement } from "../fixtures/utils";
...
describe('StackChart', function () {
  ...
  function setup({
    ...
    const getChangeJsTracerSummaryCheckbox = () => getByText(/Show only self time/);
  ...
  const simpleTracerEvents = [['https://mozilla.org', 0, 20], ['Interpreter', 1, 19], ['IonMonkey', 2, 18]];
