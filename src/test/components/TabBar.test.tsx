...
describe('app/TabBar', () => {
  it('renders the TabBar and handles clicks properly', () => {
    ...
    const {
      getByText,
      container
    } = render(<TabBar selectedTabSlug="flame-graph" visibleTabs={['calltree', 'flame-graph', 'stack-chart', 'marker-chart', 'marker-table', 'network-chart']} onSelectTab={handleTabSelection} />);
