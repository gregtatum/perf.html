...
describe('shared/BlobUrlLink', () => {
  ...
  it('injects a blob url into a link', () => {
    ...
    const result = render(<BlobUrlLink className="myClassName" blob={blob}>
        This is the text
      </BlobUrlLink>);
    const a = ensureExists(result.container.querySelector('a'), 'Unable to find an <a>');
  ...
  it('can update with a new blob the object url', () => {
    ...
    const result = render(<BlobUrlLink className="myClassName" blob={blob1}>
        This is the text
      </BlobUrlLink>);
    const a = ensureExists(result.container.querySelector('a'), 'Unable to find an <a>');
    ...
    result.rerender(<BlobUrlLink className="myClassName" blob={blob2}>
        This is the text
      </BlobUrlLink>);
