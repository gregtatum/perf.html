// @flow
import type { Thread, IndexIntoFuncTable, IndexIntoStackTable } from '../../common/types/profile';

/**
 * Maps a thread's sample into the height of the stack.
 */
export function mapSamplesToStackHeight({ samples, stackTable }: Thread): number[] {
...
export function getFuncIndexByName(thread: Thread, name: string) {
  return thread.funcTable.name.indexOf(
