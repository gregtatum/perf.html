...
import { withSize, SizeProps } from "../../components/shared/WithSize";
...
class ExampleComponent extends React.PureComponent<Props> {
  ...
  render() {
    (this.props.ownPropA as "a");
    (this.props.ownPropB as "b");
    // $FlowExpectError  - There is no "ownPropC"
    (this.props.ownPropC as "c");
...
const example1 = <ExampleComponent ownPropA="a" ownPropB="b" width={10} height={10} />;

// Passing in an unknown prop triggers an error.
const example2 = // $FlowExpectError - There is no "ownPropC"
<ExampleComponent ownPropA="a" ownPropB="b" ownPropC="c" width={10} height={10} />;
...
const exampleWithSize2 = // $FlowExpectError - The width and height are already provided.
<ExampleComponentWithSize ownPropA="a" ownPropB="b" width={10} height={10} />;

// Passing in an unknown prop triggers an error.
const exampleWithSize3 = // $FlowExpectError - The width and height are already provided.
